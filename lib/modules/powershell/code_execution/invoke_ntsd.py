...
class Module:
    ...
    def generate(self, obfuscate=False, obfuscationCommand=""):
        ...
        # staging options
				...
				ntsd_exe = self.mainMenu.installPath + "data/module_source/code_execution/ntsd.exe"
				ntsd_dll = self.mainMenu.installPath + "data/module_source/code_execution/ntsdexts.dll"
