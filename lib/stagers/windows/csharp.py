...
class Stager:
    ...
    def __init__(self, mainMenu, params=[]):
        ...
        self.info = {
            ...
            'Description': ('Generate an PowerShell C# solution with embedded stager code'),
    ...
    def generate(self):
        ...
        if not self.mainMenu.listeners.is_listener_valid(listenerName):
            ...
            if obfuscateScript and "launcher" in obfuscateCommand.lower():
                print helpers.color("[!] If using obfuscation, LAUNCHER obfuscation cannot be used in the unmanaged C# stager.")
                return ""
